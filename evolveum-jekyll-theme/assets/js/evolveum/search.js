        ...
        for (let i = 0; i < searchMap.length; i++) {
            if (searchMap[i].title !== undefined) {
                ...
                if (allTextWithoutWS.includes(normalize(phrase))) {
                    ...
                    const listItem = '<a style="width: 0.1%;" href="' + searchMap[i].url + '">' +
                        '<li class="list-group-item border-0"  ><i class="fas fa-align-left"></i><span class="font1">' + ' &nbsp; ' + searchMap[i].title + '<br></span>' +
